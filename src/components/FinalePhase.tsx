...
export default function FinalePhase({ progress, data }: Props) {
  ...
  const [isVisible, setIsVisible] = useState(() => progress.get() > 0.9);
      ...
      >
        <motion.div
          ...
          style={{
            ...
            overflow: "hidden",
            boxShadow:
              "0 0 60px rgba(70,130,230,0.35), 0 0 120px rgba(70,130,230,0.15)",
          }}
        >
          <Image
      ...
      {!submitted ? (
          ...
          <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
            ...
            <button
              ...
              style={{
                ...
                background: name.trim() ? "var(--accent)" : "#333",
                border: "none",
                borderRadius: "8px",
        ...
        >
          ...
          {selectedField && (
            ...
            >
              {name}, {selectedField.toLowerCase()} alanında seni büyük şeyler
              bekliyor. Rota hesaplanıyor... 🚀
            </motion.p>
          )}
        </motion.div>
      )}
